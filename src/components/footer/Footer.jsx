  ...
  return (
    <div className='h-fit py-5 w-full bg-[inherit] px-5  '>
      ...
      <div className="md:w-[30%] w-[70%]  ml-auto   mb-10 ">
        <h3 className="w-fit ml-auto text-lg text-blue-500 italic">subscribe to our email list today</h3>
        <div className="w-full h-full flex item-center bg-green-500 rounded-md">
          <input type="text" className="w-[70%] text-black h-12 pl-2 rounded-s-md outline-none" placeholder="enter your email" />
          <button className="w-[30%] text-center text-2xl">Enter</button>
        </div>
      </div>
